...
const anwserArr = [['неразрушающее исследование внутренней структуры объекта и протекающих в нём процессов с помощью различных физических методов'], ['метод исследования толщины и целостности материалов'],['поиск дефектов с помощью неразрушающих методов контроля']]; //Ответы в правильном порядке
const text = ['Толщинометрия','Интроскопия','Дефектоскопия']
