...
const anwserArr = [['манометры, термометры, гальванометры, тахометры'], ['приборы контроля веса, размеров, величины электрического сопротивления'],['регуляторы скорости, давления, температуры'],['счетчики, интеграторы, суммирующие устройства']]; //Ответы в правильном порядке
const text = ["Измерительные ", "Регулирующие", "Контрольные ", "Счетные и вычислительныe"]
